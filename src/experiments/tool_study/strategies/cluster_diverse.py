"""Cluster-based diverse retrieval strategy.

Uses intra-folder cluster centroids to identify relevant concepts, cross-folder
clusters for thematic discovery, and slot allocation to enforce diversity across
concepts in the final result set.
"""
...
class ClusterDiverseStrategy:
    ...
    def _load_cross_concept_composition(self) -> dict[int, dict[str, int]]:
        ...
        Returns mapping: {cross_cluster_id: {concept_folder_path: doc_count}}
        """
    ...
    def _rank_concepts(self, query_embedding: np.ndarray) -> list[dict]:
        ...
        Returns list of dicts with keys: folder_path, distance, source_type, cluster_id
        Deduplicated by folder_path (closest centroid wins).
        """
        ...
        # Deduplicate by folder_path, keeping closest
        seen: set[str] = set()
        deduped = []
        for item in scored:
    ...
    def _discover_concepts(
        ...
        Returns list of dicts with keys: folder_path, doc_count
        """
        ...
        # Find closest 1-2 cross-folder centroids
        scored = []
    ...
    def _allocate_slots(
        ...
        Each concept gets at least min_slots. Remaining slots are weighted
        by inverse centroid distance (closer concepts get more).

        Returns list of (folder_path, slot_count) tuples.
        """
    ...
    def search(
        ...
        **kwargs,
        ...
        # Phase 1: Identify relevant concepts via intra-folder centroids
        ...
        # Phase 2: Broaden with cross-folder discovery
        ...
        # Phase 3: Allocate slots and fetch
        ...
        # Redistribute unfilled slots across concepts (closest first)
        ...
        # Sort by distance, assign ranks, cap at k
